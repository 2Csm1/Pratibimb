"""
xgboost_model.py — Train and save the XGBoost attrition pipeline.
"""
import os
import sys
...
pipeline = {'model': xgb_model, 'scaler': scaler, 'imputer': imputer}

out = os.path.join(os.path.dirname(__file__), '..', 'models', 'xgb_pipeline.pkl')
joblib.dump(pipeline, out)
print(f"XGBoost pipeline saved → {out}")
